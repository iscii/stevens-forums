...
function CreatePost() {
	return (
		<div className="h-screen w-screen flex justify-center bg-pink-100">
			<Nav />
			<span className="h-full w-full flex flex-col items-center justify-center">
				<h1 className="text-4xl mb-16">Create Post</h1>
				<form className="w-3/6 h-3/6 bg-pri-gray border border-pri-gray rounded-3xl bg-pri-white" action="/">
