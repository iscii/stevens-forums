function Searchbar() {
	return (
		<form action="/" className="w-4/6 h-12 flex justify-end items-center">
			<input type="text" placeholder="Search..." className="w-full h-full border bg-pri-gray border-pri-gray rounded-2xl px-3 focus:outline-none focus:border-dark-gray" />
